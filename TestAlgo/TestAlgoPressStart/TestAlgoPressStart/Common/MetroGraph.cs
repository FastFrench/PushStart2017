...
namespace Assets.Common
{
    public class MetroGraph
    {
        ...
        public System.Diagnostics.Stopwatch LastOperationTime { get; set; }
        public float ComputeDijkstra(Station from, Station to)
        {
            LastOperationTime = System.Diagnostics.Stopwatch.StartNew();
            ...
            Debug.LogFormat("Durée du traitement: {0}. Closed list contains {1} values. Distance: {2:N2}", LastOperationTime.Elapsed, closed.Count, minDistance);
            return minDistance;
        }
        #endregion Dijkstra
